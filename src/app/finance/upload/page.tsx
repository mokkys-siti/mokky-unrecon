...
export default function UploadPage() {
  ...
  async function upload() {
    ...
    setBusy(false);
    setFiles([]); // clear the tray; results remain
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-1 text-sm text-gray-600">
        ...
        is fine. Each is parsed and staged for review; nothing publishes automatically.
      </p>

      {/* Picker */}
      <label
        htmlFor="files"
        className="mt-6 flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-brand-white px-6 py-10 text-center hover:border-brand-orange"
